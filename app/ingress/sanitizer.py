...
from app.ingress.custom_nlp import NoOpNlpEngine
...
class SanitizerService:
    ...
    async def sanitize_and_store(self, prompt:str) -> dict:
        ...
        #resetting entity_counts to empty
        entity_counts = {}
        ...
        def custom_mask(entity_type:str):
            ...
            def _mask(text_to_mask:str)->str:
                ...
                return f"<{entity_type}_{entity_counts[entity_type]}>"
            return _mask
        ...
        anonymized_result = self.anonymizer.anonymize(text=prompt, analyzer_results=sorted_results, operators=operators)
